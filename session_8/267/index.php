<?php
  ...
  // O resultado dessas comparações são, tipicamente, valores booleanos.  
  ...
  // <=>  
  // int(1) se o primeiro valor for maior  
  var_dump(20 <=> 10); // int(1)  
  // int(0) se os valores forem iguais  
  var_dump(10 <=> 10); // int(0)  
  // int(-1) se o primeiro valor for menor  
