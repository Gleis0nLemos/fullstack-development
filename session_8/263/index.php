<?php
  ...
  */  
  ...
  var_dump($x + $y); // int(7) - adição  
  var_dump($x - $y); // int(-3) - subtração  
  var_dump($x * $y); // int(10) - multiplicação  
  var_dump($y / $x); // float(2.5) - divisão  
  var_dump($y % $x); // int(1) - resto da divisão  
  var_dump($x ** $y); // int(32) - potenciação - 2 elevado a 5  
  ...
  var_dump(10 / 2); // int(5)  
  var_dump(10 / 3); // float(3.3333333333335)  
  ...
  var_dump(fmod(10.5, 3.2)); // float(0.89999999999995)
